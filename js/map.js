var map = {
    ...
    init: function (mission_info, spot_info, enemy_team_info, enemy_character_type_info, gun_info, ally_team_info, building_info) {
        ...
        map.building_info = building_info;
